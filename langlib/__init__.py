...
def abbreviation(text):
	...
	'a method that may be very, very useful to you; As the name implies, this method gives you the abbreviation of several words; Just give it a String.'	speld,result = [] , ""
